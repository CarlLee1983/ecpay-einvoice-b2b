...
use ecPay\eInvoiceB2B\Queries\GetInvalidConfirm;
use PHPUnit\Framework\TestCase;

class GetInvalidConfirmTest extends TestCase
{
    private GetInvalidConfirm $query;

    protected function setUp(): void
    {
        $this->query = new GetInvalidConfirm(
    ...
    {
        $this->assertEquals('/B2BInvoice/GetInvalidConfirm', $this->query->getRequestPath());
    }
