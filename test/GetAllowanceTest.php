...
class GetAllowanceTest extends TestCase
{
    private GetAllowance $query;

    protected function setUp(): void
    {
        $this->query = new GetAllowance(
    ...
    {
        $this->assertEquals('/B2BInvoice/GetAllowance', $this->query->getRequestPath());
    }
