...
use CarlLee\EcPayB2B\Queries\GetAllowanceInvalidConfirm;
use PHPUnit\Framework\TestCase;

class GetAllowanceInvalidConfirmTest extends TestCase
{
    private GetAllowanceInvalidConfirm $query;

    protected function setUp(): void
    {
        $this->query = new GetAllowanceInvalidConfirm(
    ...
    {
        $this->assertEquals('/B2BInvoice/GetAllowanceInvalidConfirm', $this->query->getRequestPath());
    }
