...
use ecPay\eInvoiceB2B\Queries\GetAllowanceConfirm;
use PHPUnit\Framework\TestCase;

class GetAllowanceConfirmTest extends TestCase
{
    private GetAllowanceConfirm $query;

    protected function setUp(): void
    {
        $this->query = new GetAllowanceConfirm(
    ...
    {
        $this->assertEquals('/B2BInvoice/GetAllowanceConfirm', $this->query->getRequestPath());
    }
