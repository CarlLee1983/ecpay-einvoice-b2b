 ...
 * 查詢折讓發票確認 API。
 *
 * 特店(營業人)可使用此 API 查詢發票折讓是否完成確認資訊，
 * 綠界會以回傳參數方式回覆該張發票折讓資料。此方式可協助特店(營業人)將查詢折讓發票確認機制
 * 整合至營業人網站，提供快速查詢服務。
 *
 * @see https://developers.ecpay.com.tw/?p=14973
 */
class GetAllowanceConfirm extends Content
{
    /**
     * API endpoint path.
     *
     * @var string
     */
    protected string $requestPath = '/B2BInvoice/GetAllowanceConfirm';
