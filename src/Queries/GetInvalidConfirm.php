 ...
 * 查詢作廢發票確認 API。
 *
 * 特店(營業人)可使用此 API 查詢已作廢發票是否完成確認資訊，包括銷項發票及進項發票，
 * 綠界會以回傳參數方式回覆該張發票資料。此方式可協助特店(營業人)將查詢發票作廢確認機制
 * 整合至特店(營業人)網站，提供快速查詢服務。
 *
 * @see https://developers.ecpay.com.tw/?p=14953
 */
class GetInvalidConfirm extends Content
{
    /**
     * API endpoint path.
     *
