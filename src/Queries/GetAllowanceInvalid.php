 ...
 * 查詢作廢折讓發票 API。
 *
 * 特店(營業人)可使用此 API 查詢已作廢發票折讓資訊，
 * 綠界會以回傳參數方式回覆該張作廢折讓發票資料。此方式可協助特店(營業人)將查詢作廢折讓發票機制
 * 整合至營業人網站，提供快速查詢服務。
 *
 * @see https://developers.ecpay.com.tw/?p=14978
 */
class GetAllowanceInvalid extends Content
{
     ...
     * @var string
     */
    protected string $requestPath = '/B2BInvoice/GetAllowanceInvalid';
