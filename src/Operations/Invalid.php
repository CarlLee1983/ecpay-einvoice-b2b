 ...
 * (以下簡稱綠界)後，由綠界暫存相關資料。綠界會於隔日將發票作廢後上傳至財政部電子發票整合服務平台，
 * 同時根據發送通知API設定，通知交易相對人(營業人)電子發票已作廢。
 *
 * 注意：根據財政部規定，需等待交易相對人(營業人)確認後才完成交換作廢。
 *
 * @see https://developers.ecpay.com.tw/?p=14860
 */
class Invalid extends Content
{
    /**
     * API endpoint path.
     *
     * @var string
     */
    protected string $requestPath = '/B2BInvoice/Invalid';
