 ...
 * 作廢折讓發票確認 API。
 *
 * 特店(營業人)收到作廢折讓發票訊息通知後，傳送作廢折讓發票確認參數給綠界科技加值中心(以下簡稱綠界)，
 * 由綠界暫存相關資料。綠界會於隔日將作廢折讓發票確認訊息後上傳至財政部電子發票整合服務平台，
 * 完成折讓作廢交換。並根據發送通知API設定，通知交易相對人(營業人)電子折讓作廢已完成確認。
 *
 * @see https://developers.ecpay.com.tw/?p=14894
 */
class AllowanceInvalidConfirm extends Content
{
    /**
     * API endpoint path.
     *
     * @var string
     */
    protected string $requestPath = '/B2BInvoice/AllowanceInvalidConfirm';
